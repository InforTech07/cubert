...
interface LayoutProps {
  ...
  showDock?: boolean; // Nueva prop para controlar la visibilidad del dock
}

const Layout: React.FC<LayoutProps> = ({ children, showDock = true }) => {
  return (
    <div className="min-h-screen w-full relative overflow-hidden" style={{ background: 'var(--futuristic-bg)' }}>
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        {/* Dock futurista fijo - solo se muestra si showDock es true */}
        {showDock && (
          <div className='absolute bottom-6 left-1/2 max-w-full -translate-x-1/2'>
